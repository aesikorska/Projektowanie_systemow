...
# Tak, dokumenty mogą zawierać między innymi przemowy polityczne i teksty o zarządzaniu
# 2- Jakich ogólnie obszarów tematycznych dotyczą klastry oraz ile jest tych obszarów?
# Zgodnie z metodą sylwetki są dwa główne obszary. 
# Pierwszy dotyczy czegoś związanego z projektami i zarządaniem
# Drugi dotyczy Ameryki.
