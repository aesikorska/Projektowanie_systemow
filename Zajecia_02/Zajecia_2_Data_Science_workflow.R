...
# 2.6. Łączenie (scalanie) ramek danych w jedną ----
...
# 3.1. Najczęściej używane funkcje pakietu dplyr: ----
...
# 3.2. mutate() – tworzenie nowych zmiennych na bazie istniejących ----
...
# 3.7. summarise() - obliczanie wartości zagregowanych (np. średnich, sum) ----
